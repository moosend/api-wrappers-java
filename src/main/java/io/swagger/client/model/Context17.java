...
import io.swagger.client.model.ImportOperation19;
...
public class Context17 {
  ...
  private ImportOperation19 importOperation = null;
  ...
  public Context17 activeMemberCount(Double activeMemberCount) {
  ...
  **/
  ...
  public Context17 bouncedMemberCount(Double bouncedMemberCount) {
  ...
  **/
  ...
  public Context17 createdBy(String createdBy) {
  ...
  **/
  ...
  public Context17 createdOn(String createdOn) {
  ...
  **/
  ...
  public Context17 customFieldsDefinition(List<CustomFieldsDefinition> customFieldsDefinition) {
    this.customFieldsDefinition = customFieldsDefinition;
    return this;
  }

  public Context17 addCustomFieldsDefinitionItem(CustomFieldsDefinition customFieldsDefinitionItem) {
  ...
  **/
  ...
  public Context17 importOperation(ImportOperation19 importOperation) {
  ...
  **/
  @ApiModelProperty(value = "")
  public ImportOperation19 getImportOperation() {
    return importOperation;
  }

  public void setImportOperation(ImportOperation19 importOperation) {
    this.importOperation = importOperation;
  }

  public Context17 name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public Context17 removedMemberCount(Double removedMemberCount) {
  ...
  **/
  ...
  public Context17 status(Double status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public Context17 unsubscribedMemberCount(Double unsubscribedMemberCount) {
  ...
  **/
  ...
  public Context17 updatedBy(String updatedBy) {
  ...
  **/
  ...
  public Context17 updatedOn(String updatedOn) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Context17 context17 = (Context17) o;
    return Objects.equals(this.activeMemberCount, context17.activeMemberCount) &&
        Objects.equals(this.bouncedMemberCount, context17.bouncedMemberCount) &&
        Objects.equals(this.createdBy, context17.createdBy) &&
        Objects.equals(this.createdOn, context17.createdOn) &&
        Objects.equals(this.customFieldsDefinition, context17.customFieldsDefinition) &&
        Objects.equals(this.ID, context17.ID) &&
        Objects.equals(this.importOperation, context17.importOperation) &&
        Objects.equals(this.name, context17.name) &&
        Objects.equals(this.removedMemberCount, context17.removedMemberCount) &&
        Objects.equals(this.status, context17.status) &&
        Objects.equals(this.unsubscribedMemberCount, context17.unsubscribedMemberCount) &&
        Objects.equals(this.updatedBy, context17.updatedBy) &&
        Objects.equals(this.updatedOn, context17.updatedOn);
  }
