...
**senderEmail** | **String** | The sender email of the campaign. |  [optional]
**replyToEmail** | **String** | The email address to which recipients replies will arrive. It must be one of your sender accounts. If not specified, the sender&#39;s email will be assumed. |  [optional]
**isAB** | **String** | A flag that defines if a campaign is an AB campaign. |  [optional]
...
**mailingLists** | [**List&lt;MailingLists&gt;**](MailingLists.md) | A list of mailing lists in your account to which the campaign will be sent to. |  [optional]
